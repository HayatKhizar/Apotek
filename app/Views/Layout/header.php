...
<head>
    ...
    <link href="<?= base_url('vendor/vendor/vendor/cssSaya.css'); ?>" rel="stylesheet">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="Barang.html"><span
                                    class="  text-gray-600 ">Barang</span></a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="Transaksi.html"><span class="text-gray-600 ">Transaksi</span></a>
                        </li>
